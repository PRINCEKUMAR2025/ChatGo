...
import com.example.chatcraze.adapters.ChatAdapter;
import com.example.chatcraze.databinding.ActivityChatBinding;
import com.example.chatcraze.models.ChatMessage;
import com.example.chatcraze.models.User;
import com.example.chatcraze.network.ApiClient;
import com.example.chatcraze.network.ApiService;
    ...
    private void checkForConversion(){
        if (chatMessages.size() != 0){
            checkForConversionRemotely(
                    preferenceManager.getString(Constants.KEY_USER_ID),recieverUser.id
            );
            checkForConversionRemotely(
                    recieverUser.id,preferenceManager.getString(Constants.KEY_USER_ID)
            );
        }
    }
